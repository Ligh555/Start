...
public class TabLayout extends HorizontalScrollView {
  ...
  private final TabLayoutResHelper tabLayoutResHelper;
  ...
  @NonNull
  protected static ColorStateList createColorStateList(int defaultColor, int selectedColor) {
